...
namespace Vidly
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            if (!string.IsNullOrWhiteSpace(SiteConfig.Config.Site.FacebookAppId) &&
                !string.IsNullOrWhiteSpace(SiteConfig.Config.Site.FacebookAppSecret))
            {
                app.UseFacebookAuthentication(
                   appId: SiteConfig.Config.Site.FacebookAppId,
                   appSecret: SiteConfig.Config.Site.FacebookAppSecret);
            }
